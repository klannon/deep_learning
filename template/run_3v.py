...
def init_train(learningRate, batchSize, numLayers, nodesPerLayer,
    ...
    dataset_train.load_from_file(path_to_train_X, path_to_train_Y, benchmark='ttbar_wjet_3v', which_set='train')
    dataset_test.load_from_file(path_to_test_X, path_to_test_Y, benchmark='ttbar_wjet_3v', which_set='test')
