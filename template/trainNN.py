...
if __name__ == "__main__":
    ...
    parser.add_argument("-sf", "--saveFrequency", help="how often the model "
                        + "should be saved and backed up", default=100,
                        type=int)
    parser.add_argument("-c", "--customName", help="name for the log and pkl "
                        + "files from your model", default=None)
    parser.add_argument("-m", "--benchmark", help="keyword[s] that represent "
                        + "the type of data",default=None)
    parser.add_argument("-s", "--saveDir", help="parent directory to save the "
                        + "results in", default='.')
    parser.add_argument("--continue", help="continue training based upon a "
                        + ".cfg file", default=None)
    parser.add_argument("--idpath", help="The path to your .pkl file, but "
                        + "WITHOUT the extension", default=None)
