...
all of the information about your experiment when you ran it in the
first place (if the version of trainNN.py that you used didn't save a
.experiment file describing the experiment you ran).  You should edit
the variables in this script to properly describe the experiment you
ran, and then run
